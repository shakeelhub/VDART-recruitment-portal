...
export const generateEmailSignature = (managerDetails) => {
...
// Complete email template with signature
export const generateDeploymentEmailTemplate = (formData, managerDetails, content = '') => {
    const {
    ...
    const signature = generateEmailSignature(managerDetails);
